                            ...
                            <Grid item xs={12} sm={3}>
                                <FormControl fullWidth>
                                    ...
                                    <Select labelId="tittle-label" id="tittle" name="saluation" value={saluation} onChange={onInputChange}>
                                        {choiceList.length > 0 ? choiceList.user_salutation.map((item, index) => (
                                            <MenuItem value={item.name} id={item.slug}>{item.name}</MenuItem>
                                        )) : []}
                                    </Select>
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item xs={12} sm={2}>
                                <FormControl component="fieldset">
                                    ...
                                    <RadioGroup aria-label="gender" name="gender" value={gender} onChange={onInputChange}>
                                        {choiceList.length > 0 ? choiceList.gender.map((item, index) => (
                            ...
                            <Grid item xs={12} sm={3.3} ml={-1} mt={2}>
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        onChange={onInputChange}
                                    >
                                        {choiceList.length > 0 ? choiceList.martial_status.map((item, index) => (
                                            <MenuItem id={item.slug} value={item.name}>{item.name}</MenuItem>
                                        )) : []}
                            ...
                            <Grid item xs={12} sm={3.3} ml={-1} mt={2}>
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        onChange={onInputChange}
                                    >
                                        {choiceList.length > 0 ? choiceList.educational_qualification.map((item, index) => (
                                            <MenuItem value={item.name} id={item.slug}>{item.name}</MenuItem>
                                        )) : []}
                        ...
                        <Grid item xs={12} sm={4}>
                            <FormControl fullWidth>
                                ...
                                <Select
                                    ...
                                    onChange={onInputChange}
                                >
                                    {choiceList.length > 0 ? choiceList.user_realtions.map((item, index) => (
                                        <MenuItem value={item.name} id={item.slug}>{item.name}</MenuItem>
                                    )) : []}
